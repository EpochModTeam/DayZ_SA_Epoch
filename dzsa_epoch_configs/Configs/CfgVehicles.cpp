class CfgVehicles
{
	...
	///walls
	class plywindowKit : FenceKit
	{
		scope = 2;
		//model = "\emt\dzsa_epoch_pv_assets\emt\baseb\woodwalls\plywindowkit.p3d";
		model = "\DZ\gear\camping\fence_kit.p3d";
		displayName = "Plywood Wall w/ Window Kit";
		descriptionShort = "Plywood Wall w/ Window Kit";
	...
	class plywindowKitPlacing : FenceKit
	{
		scope = 2;
		model = "\emt\dzsa_epoch_pv_assets\emt\baseb\woodwalls\plywall_window_placing.p3d";
		//model = "\DZ\gear\camping\fence_kit_placing.p3d";
		
		displayName = "Plywood Wall w/ Window Kit Placing";
		descriptionShort = "Plywood Wall w/ Window Kit Placing";
		hiddenSelections[] =
		{
			"placing"
		};
		...
		hologramMaterialPath = "dz\gear\camping\data";/// change this
		slopeLimit = 0.25;
	};
	class plywindow : Inventory_Base
	{
		scope = 2;
		displayName = "Plywood Wall w/ Window";
		descriptionShort = "Plywood Wall w/ Window";
		model = "\emt\dzsa_epoch_pv_assets\emt\baseb\woodwalls\plywall_window.p3d";
		bounding = "BSphere";
