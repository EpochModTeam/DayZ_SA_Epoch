...
class DZE_BotSpawnEntityInHands extends BotStateBase
{
	string m_Type;
...
class DZE_BotOpenEntityInHands extends BotStateBase
{
	EntityAI m_Entity;
...
class DZE_Bot_TestSpawnOpen extends BotStateBase
{
	string m_Type;
...
class DZE_BotWaitForEmptyHands extends BotStateBase
{
	override void OnEntry (BotEventBase e) { super.OnEntry(e); }
	override void OnAbort (BotEventBase e) { super.OnAbort(e); }
	override void OnExit (BotEventBase e) { super.OnExit(e); }
