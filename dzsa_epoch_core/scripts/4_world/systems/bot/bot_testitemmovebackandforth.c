class DZE_BotTestItemMoveBackAndForth extends BotStateBase
{
	EntityAI m_Entity;
	ref DZE_BotTestItemMoveBackAndForth_MoveFromSlotToSlot m_Move;
	...
	void BotTestItemMoveBackAndForth (Bot bot = NULL, BotStateBase parent = NULL)
	{
		...
		m_Move = new DZE_BotTestItemMoveBackAndForth_MoveFromSlotToSlot(m_Bot, this);
	...
	override void OnEntry (BotEventBase e)
	{
		...
		EntityAI hgear = m_Owner.GetInventory().FindAttachment( InventorySlots.GetSlotIdFromString("Jeans_Blue") );
		EntityAI mask = m_Owner.GetInventory().FindAttachment( InventorySlots.GetSlotIdFromString("TacticalShirt_Grey") );
...
class DZE_BotTestItemMoveBackAndForth_MoveFromSlotToSlot extends BotStateBase
{
	EntityAI m_Entity;
	int m_WaitingForSlot = InventorySlots.INVALID;
	int m_hgSlot = InventorySlots.GetSlotIdFromString("Jeans_Blue");
	int m_mskSlot = InventorySlots.GetSlotIdFromString("TacticalShirt_Grey");
