...
class DZE_MyBotTrigger extends MyBotTrigger
{
	//PlayerBase m_Owner;
	override void MyBotTrigger (PlayerBase p) { m_Owner = p; }
...
class DZE_Bot extends Bot
{
	...
	override void Start (bool use_trigger, BotTrigger trigger = null)
	{
		...
		if (m_UseTrigger)
		{
			...
			botDebugPrint("Epoch Modded Bot Running.");
